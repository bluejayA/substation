// Sources/Substation/Modules/Magnum/Views/ClusterTemplateCreateView.swift
import Foundation
import OSClient
import SwiftNCurses

/// ClusterTemplateCreateView using FormBuilder component
///
/// This view renders the cluster template creation form using the unified
/// FormBuilder component for consistent UI across all create forms.
struct ClusterTemplateCreateView {
    // Layout Constants
    ...
    private static let formTitle = "Create Cluster Template"
    private static let creatingText = "Creating cluster template..."
    private static let errorPrefix = "Error: "

    /// Main rendering function for the cluster template create form
    ///
    /// - Parameters:
    ...
    ///   - form: The cluster template create form data
    ...
    static func draw(
        ...
        width: Int32,
        height: Int32,
        form: ClusterTemplateCreateForm,
