...
struct VolumeSnapshotManagementView {
    ...
    private static let loadingMessage = "Creating volume snapshot..."
    private static let createSnapshotTitle = "Create Volume Snapshot - "
    ...
    static func draw(
        ...
        width: Int32,
        height: Int32,
        form: VolumeSnapshotManagementForm,
        ...
        let headerText = "\(Self.createSnapshotTitle)\(volumeName)"
